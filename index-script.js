const menuData = [
    ...
    { name: "This and that", cat: "Media", link: "https://yblebon.github.io/this-and-that", icon: "fas fa-ellipsis-h", description: "Random thoughts.", color: "#26a69a" },
    ...
    { name: "Books", cat: "Knowledge", link: "https://yblebon.github.io/books", icon: "fas fa-book-open", description: "Books.", color: "#5c6bc0" },
    ...
    { name: "Jokes", cat: "Fun", link: "https://yblebon.github.io/jokes", icon: "fas fa-laugh-beam", description: "Funny moments.", color: "#ef5350" },
    ...
    { name: "Image Uploader", cat: "Tools", link: "https://yblebon.github.io/image-uploader/", icon: "fas fa-camera-retro", description: "Upload images.", color: "#8d6e63" },
    ...
    { name: "Text To PDF", cat: "Tools", link: "https://yblebon.github.io/text-2-pdf/", icon: "fas fa-file-pdf", description: "Text to PDF.", color: "#8d6e63" },
    { name: "Jsonformatter", cat: "Tools", link: "https://yblebon.github.io/json-formatter", icon: "fas fa-code", description: "Beautify JSON.", color: "#8d6e63" },
    { name: "Color picker", cat: "Tools", link: "https://yblebon.github.io/color-picker", icon: "fas fa-palette", description: "Custom colors.", color: "#8d6e63" },
    ...
    { name: "Terminal", cat: "Tools", link: "https://terminal.yasserblebon.com", icon: "fas fa-terminal", description: "Terminal.", color: "#8d6e63" },
